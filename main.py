...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    layer4_in = tf.layers.conv2d_transpose(layer7_conv_1x1, num_classes, 4, strides= (2, 2), padding= 'same', 
                                   kernel_initializer= tf.random_normal_initializer(stddev=1e-3), 
                                   kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
    ...
    layer4_out = tf.add(layer4_in, layer4_conv_1x1)
    
    layer3_conv_1x1 = tf.layers.conv2d_transpose(layer4_out, num_classes, 4, strides= (2, 2), padding= 'same', 
                                   kernel_initializer= tf.random_normal_initializer(stddev=1e-3), 
                                   kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
    ...
    layer3_out = tf.add(layer3_conv_1x1, layer3_in)
